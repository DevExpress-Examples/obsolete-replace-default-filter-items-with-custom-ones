...
namespace CustomFilterPopupSample {
    public class CustomFilterRanges {
        ...
        public CustomFilterRanges(PivotGridControl pivot, PivotGridField field) {
            this.pivot = pivot;
            targetField = field;
        }
        public void AddEvents() {
            pivot.CustomFilterPopupItems +=
                new PivotCustomFilterPopupItemsEventHandler(pivot_CustomFilterPopupItems);
            pivot.FieldFilterChanging +=
                new PivotFieldFilterChangingEventHandler(pivot_FieldFilterChanging);
        }
        public void Detach() {
        ...
        Dictionary<string, List<object>> GetCustomRanges(IEnumerable<object> filterItemsCollection) {
